...
class JanelaEPIs:
    ...
    def criar_janela(self):
        ...
        self.janela.title("Cadastro de EPIs")
    ...
    def criar_formulario(self):
        ...
        lbl_titulo = tk.Label(frame_principal,
                              text="CADASTRO DE EPIs (EQUIPAMENTOS DE PROTEÇÃO INDIVIDUAL)",
                              font=('Arial', 12, 'bold'),
                              bg=self.cor,
                              fg='black')
    ...
    def salvar_epi(self):
        ...
        if all(dados[:3]):  # Tipo, marca e CA
            messagebox.showinfo("Sucesso", "EPI cadastrado com sucesso!")
            self.limpar_campos()
        else:
