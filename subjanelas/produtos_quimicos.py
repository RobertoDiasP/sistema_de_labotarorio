...
class JanelaProdutosQuimicos:
    ...
    def criar_janela(self):
        ...
        self.janela.title("Cadastro de Produtos Químicos/Biológicos")
        self.janela.geometry("550x550")
    ...
    def criar_formulario(self):
        ...
        lbl_titulo = tk.Label(frame_principal,
                              text="CADASTRO DE PRODUTOS QUÍMICOS/BIOLÓGICOS",
                              font=('Arial', 14, 'bold'),
                              bg=self.cor,
                              fg='black')
        ...
        campos = [
            ...
            ("Fabricante:", 1),
            ("Nº de Registro:", 2),
            ("Tipo (Químico/Biológico):", 3),
            ("Classificação de Risco:", 4),
            ("Data de Validade:", 5),
            ("Quantidade em Estoque:", 6),
            ("Local de Armazenamento:", 7)
        ]
        ...
        for texto, linha in campos:
            ...
            lbl.grid(row=linha, column=0, sticky='w', pady=3, padx=5)
    ...
    def salvar_produto(self):
        ...
        if all(dados[:3]):  # Nome, fabricante e registro
